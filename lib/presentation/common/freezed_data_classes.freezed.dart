...
class _$RegisterObjectTearOff {
  ...
  _RegisterObject call(String email, String password, String mobileNumber,
      String userName, String profilePicture, String countryMobileCode) {
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.email, this.password, this.mobileNumber, this.userName,
      this.profilePicture, this.countryMobileCode);
  ...
  @override
  String toString() {
    return 'RegisterObject(email: $email, password: $password, mobileNumber: $mobileNumber, userName: $userName, profilePicture: $profilePicture, countryMobileCode: $countryMobileCode)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      String userName,
      String profilePicture,
      String countryMobileCode) = _$_RegisterObject;
